...
dns_records = {
    ...
    'nyu.edu.': {
        ...
        dns.rdatatype.TXT: str(encrypted_data, 'utf-8'),  # Convert bytes to string
        ...
        try:
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                if qtype == dns.rdatatype.MX:
                    ...
                    nsname, mboxname, serial, refresh, retry, expire, minimum = answer_data # What is the record format? See dns_records dictionary. Assume we handle @, Class, TTL elsewhere. Do some research on SOA Records
                    rdata = SOA(dns.rdataclass.IN, dns.rdatatype.SOA, nsname, mboxname, serial, refresh, retry, expire, minimum) # follow format from previous line
